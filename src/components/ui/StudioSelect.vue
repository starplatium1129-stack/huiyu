...
.studio-select-content[data-state='open'] { animation:studio-select-in var(--motion-surface) var(--ease-out) both; }
.studio-select-content[data-state='closed'] { animation:studio-select-out var(--motion-hover) var(--ease-out) both; }
@keyframes studio-select-in { from { opacity:0; transform:translateY(-3px) scale(.98); } to { opacity:1; transform:none; } }
@keyframes studio-select-out { from { opacity:1; transform:none; } to { opacity:0; transform:translateY(-2px) scale(.99); } }
...
@media (prefers-reduced-motion: reduce) {
  ...
  .studio-select-content[data-state] { animation: none; }
}
