...
.studio-popover[data-state='open'] { animation:studio-popover-in var(--motion-hover) var(--ease-out); }
@keyframes studio-popover-in { from { opacity:0; transform:translateY(-3px) scale(.98); } to { opacity:1; transform:none; } }
@media(prefers-reduced-motion:reduce) { .studio-popover[data-state='open'] { animation:none; } }
