...
const { resolveReferenceRelease } = require('../scripts/lib/reference-candidate-publish');
const { child, readBytes, digest } = require('../scripts/lib/resource-install-fs');
...
module.exports = { createReferenceResources };
