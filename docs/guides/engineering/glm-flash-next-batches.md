...
最新复核：A、RB、RC 已收尾；RD 的 F03/F05/F08b/F09 已纳入正式测试，其余用例单列未验收。N1/N2 的首页与角色详情图片回退已由主任务补修并整合，验收见 [汇总记录](../../research/engineering/six-task-review-2026-09-13.md#n1n2-首页与角色详情图片回退)。继续执行选文末 N3；其他批次保留交接记录，不再重做。
