...
> 本版替代 PR #10 初稿 `188d9b6e` 的执行顺序与协议说明。R0–R11 主线代码、正式安装、当前旧来源 3002 迁移及独立界面切换已完成，详见 [R3–R11 主线记录](R3-R11-EXECUTION-REPORT.md)。旧来源和 D 盘独立备份保留；历史 3000 来源的凭据未合并/迁移。R12/R13 仍为独立实验。
...
R0–R11 是主线；R12/R13 为独立实验。R0–R11 主线代码、正式安装、当前旧来源 3002 迁移及独立界面切换已完成，详见 [R3–R11 主线记录](R3-R11-EXECUTION-REPORT.md)。旧来源和 D 盘独立备份保留；历史 3000 来源的凭据未合并/迁移。R12/R13 仍为独立实验。 每批文件与命令详见执行手册，代码、隔离与真实发布证据分开记录。
