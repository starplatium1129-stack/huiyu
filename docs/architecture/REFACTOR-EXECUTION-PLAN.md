...
> 修订：2026-09-27；设计审查基线 `8939d9769501788482968eb6666a584adab739c1`。
> 本版替代 PR #10 初稿 `188d9b6e` 的执行顺序与协议说明。R0–R11 主线代码、正式安装、当前旧来源 3002 迁移及独立界面切换已完成，详见 [R3–R11 主线记录](R3-R11-EXECUTION-REPORT.md)。旧来源和 D 盘独立备份保留；历史 3000 来源的凭据未合并/迁移。R12 独立渲染进程实验已完成本机对照且默认关闭，见 [R12 记录](R12-EXECUTION-REPORT.md)；R13 Electron 宿主实验也已完成同 UI/本机对照，保留 Tauri 默认，见 [R13 记录](R13-EXECUTION-REPORT.md)。
...
R0–R11 是主线；R12/R13 为独立实验。R0–R11 主线代码、正式安装、当前旧来源 3002 迁移及独立界面切换已完成，详见 [R3–R11 主线记录](R3-R11-EXECUTION-REPORT.md)。旧来源和 D 盘独立备份保留；历史 3000 来源的凭据未合并/迁移。R12 独立渲染进程实验已完成本机对照且默认关闭，见 [R12 记录](R12-EXECUTION-REPORT.md)；R13 Electron 宿主实验也已完成同 UI/本机对照，保留 Tauri 默认，见 [R13 记录](R13-EXECUTION-REPORT.md)。 每批文件与命令详见执行手册，代码、隔离与真实发布证据分开记录。
