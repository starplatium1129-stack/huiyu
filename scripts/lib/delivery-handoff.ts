...
'use strict';
const { object, canonical, evidencePath, fileEntry, readJson }: typeof import('./delivery-paths') = require('./delivery-paths');
const { snapshot, repository, HASH }: typeof import('./delivery-identity') = require('./delivery-identity');
const { get, set, state, gatePath, MAIN_FIELDS }: typeof import('./delivery-state') = require('./delivery-state');
...
export = { capture, inspectHandoff, mainRequirements };
