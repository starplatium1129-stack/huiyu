...
const { CODE_ROOT, hash, noLinks } = require('./generation-candidates');
const { lockFile, writeJson, flushDir } = require('./resource-install-fs');
const R = require('./reference-candidate-review');
...
module.exports = { MARKER, VIEW, scanImages, resolveReferenceRelease, preparePublication, publishReferenceCandidates };
