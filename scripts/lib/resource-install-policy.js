...
const { compareManifests, checkManifestPath, verifyManifestEntries } = require('./resource-manifest');
const { manifestContentIdentity } = require('./resource-pack-delta');
const { verifyDeltaPackContent } = require('./resource-pack-verify');
const { access, fail, digest, child, noLinks, readBytes, relativePath } = require('./resource-install-fs');
...
module.exports = { HASH, ID, manifest, releasePolicy, reference, validateReference, packageIdentity, decodePack,
