...
function fileEntry(root, name) {
  ...
  try {
    ...
    return { path: name, status: error.code === 'ENOENT' ? 'missing' : 'unsafe-or-unreadable', message: error.message };
...
module.exports = { EVIDENCE_DIR, object, canonical, sha256, relative, within, excluded, evidencePath, rootPath, resolveSafe, fileEntry, readJson, saveJson };
