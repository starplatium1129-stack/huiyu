...
const { VERSIONED_FILES } = require('./data-version');
...
function ensureDirectory(file) {
  ...
  try { fs.mkdirSync(file); } catch (error) { if (error.code !== 'EEXIST') throw error; }
...
module.exports = { fs, path, crypto, failure, keyPath, samePath, within, canonical, digest, equal, stat, safePath, directoryIdentity,
