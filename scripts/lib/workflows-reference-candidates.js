...
const command = action => ['node', 'scripts/maintenance/reference-candidate-workflow.js', action];
const evidence = 'scripts/maintenance/reference-candidate-workflow.js:1';
const referenceCandidateWorkflows = {
  'reference:inspect': {
...
module.exports = { referenceCandidateWorkflows };
