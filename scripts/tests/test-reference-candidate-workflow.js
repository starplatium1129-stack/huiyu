...
const R = require('../lib/reference-candidate-review');
const P = require('../lib/reference-candidate-publish');
const cli = require('../maintenance/reference-candidate-workflow');
const generator = require('../maintenance/render-all-outfits-references');
const { referenceView } = require('./reference-view-fixture');
const Ajv = require('ajv');
const ajv = new Ajv({ allErrors: true });
const validateView = ajv.compile(require('../contracts/character-reference-view.schema.json'));
