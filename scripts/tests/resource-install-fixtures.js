...
const { stageResourcePackDelta, manifestContentIdentity } = require('../lib/resource-pack-delta');
...
module.exports = { fs, path, assert, write, json, snapshot, approve, fixture, code };
