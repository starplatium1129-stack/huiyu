...
const { fixture, temp, tree, EVIDENCE_DIR } = require('./delivery-fixture');
const { capture } = require('../lib/delivery-handoff');
const { saveJson, sha256 } = require('../lib/delivery-paths');
const { parse } = require('../maintenance/capture-delivery');
const { report, state } = require('../maintenance/audit-delivery');
