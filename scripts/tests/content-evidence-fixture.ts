...
function fixture(t: any) {
  ...
  const put = (directory: string, file: string, value: any) => {
  ...
  return { base, root, candidateRoot, publishedRoot, record, decisions, publication, options, exportRecords,
    put: (file: string, value: any) => put(candidateRoot, file, value), source: (file: string, value: any) => put(root, file, value), read };
}
