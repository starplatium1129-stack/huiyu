...
const { fs, path, assert, write, json, snapshot, approve, fixture, code } = require('./resource-install-fixtures');
const { stageResourcePack } = require('../lib/resource-pack');
const { generateManifest } = require('../lib/resource-manifest');
const { emptyState } = require('../lib/resource-install-state');
const { resolveInstalledResourceRoots } = require('../lib/resource-install-resolver');
