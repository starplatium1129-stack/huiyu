...
function tree(directory, excludeRuntime = false, output = {}, prefix = '') {
...
async function spawnWorker(fixture, mode = 'hold') {
...
module.exports = { createFixture, names, tree, spawnWorker };
