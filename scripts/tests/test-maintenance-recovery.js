...
const { spawnSync, spawn, fork } = require('node:child_process');
const { once } = require('node:events');
const io = require('../lib/maintenance-recovery-fs');
const { acquireMaintenanceLease, inspectMaintenanceLease, assertMaintenanceReadable, pidStatus } = require('../lib/maintenance-lease');
const { previewMaintenanceRecovery, applyMaintenanceRecovery } = require('../lib/maintenance-recovery');
const { prepareMaintenanceTransaction, rollbackMaintenanceTransaction } = require('../lib/maintenance-transaction');
const { runMaintenanceNode } = require('../lib/maintenance-transaction-process');
...
test('CLI --help and bare --plan do not inspect targets even with apply arguments', () => {
  const { main } = require('../maintenance/recover-maintenance');
