...
const { readJson } = require('../lib/maintenance-recovery-fs');
...
function main(argv = process.argv.slice(2)) {
  ...
  try {
    ...
    process.stdout.write(JSON.stringify({ ok: false, code: error.code, error: error.message, recoveryRequired: true }) + '\n');
    return 1;
  }
}
